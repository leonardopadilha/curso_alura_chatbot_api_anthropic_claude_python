...
def identificar_persona(prompt):
    prompt_do_sistema = f"""
    Faça uma análise da mensagem informada abaixo para identificar se o sentimento do cliente é: positivo, neutro ou negativo.
...
# Teste para identificar a persona
#personalidade = personas[identificar_persona("Oláaa, me ajuda com na minha compra? :) <3")]
#print(personalidade)