...
def pega_detalhes_do_pedido(codigo_pedido):
  pedidos = {
    "C001": { "id": "01", "preço": "R$25,00", "status": "Em Rota de Entrega"},
    "C002": { "id": "02", "preço": "R$43,00", "status": "Confirmado"}
  }
...
def processa_chamada_de_ferramenta(nome_da_ferramenta, input_da_ferramenta):
